  ...
  return <div className="space-y-8">
      ...
      delay: 0.1
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          return <div key={agent.id} className="group rounded-xl border border-border bg-card p-5 transition-all hover:border-primary/30 cursor-pointer" onClick={() => {
      ...
      delay: 0.2
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {teamAgents.map(agent => <div key={agent.id} className="group rounded-xl border border-border bg-card p-5 transition-all hover:border-primary/30 cursor-pointer">
      ...
      delay: 0.3
        ...
        <h2 className="text-lg font-semibold text-foreground mb-4">Oracle Agents</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {galleryAgents.map(agent => {
          const GalleryIcon = agent.icon || Bot;
          return <div key={agent.id} className="group rounded-xl border border-border bg-card p-5 transition-all hover:border-primary/30 cursor-pointer">
